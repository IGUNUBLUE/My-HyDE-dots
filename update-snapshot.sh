...
copy_dot "$HOME/.config/hyde/wallbash/always/rofi-frosted.dcol" "$repo_dir/dotfiles/.config/hyde/wallbash/always/rofi-frosted.dcol"
...
copy_theme "LAGC Calm Dark"
copy_theme "LAGC Calm Light"
...
copy_dot "$HOME/.config/wlogout/style_1.css" "$repo_dir/dotfiles/.config/wlogout/style_1.css"
